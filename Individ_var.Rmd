...
path <- "C:/Users/Ben/Desktop/Policy Lab/sosure_raise_ete_clean_variable_names.xlsx"
...
##creating "package" variable and combining each package df into one df called 
"package_combined"
```{r}
full_merged <- full_merged |>
  mutate(package = "Full Graduation") |>
  relocate(package)
full_plus_merged <- full_plus_merged |>
  mutate(package = "Full Graduation Plus") |>
  relocate(package)
partial_merged <- partial_merged |>
  mutate(package = "Partial Graduation") |>
  relocate(package)
non_participants <- non_participants |>
  mutate(package = "None (Control)") |>
  relocate(package)

package_combined <- bind_rows(full_plus_merged, full_merged, partial_merged, non_participants)
```

### Claire's original analysis
```{r}
...
### Candace Analysis pt.2
##type of intervention by district
```{r}
package_combined$package <- factor(package_combined$package, 
                                  levels = c("Full Graduation Plus", "Full Graduation", "Partial Graduation", "Control (None)"))

package_combined |>
  ggplot(aes(x = District, fill = package)) +
  geom_bar(position = "dodge") +
  labs(x = "District", y = "Count", fill = "Package") +
  ggtitle("Count of Packages by District") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
```

##Assets by district by package
Beds
```{r}
package_combined |>
  select(`C1. Which of the following household items do you have?/Beds`, package, District) |>
  group_by(package, District) |>
  summarize(
    bed = mean(`C1. Which of the following household items do you have?/Beds`)) |>
  mutate(bed = bed * 100)|>
  ggplot(aes(x = District, y = bed, fill = package)) +
  geom_bar(stat = "identity", position = "dodge") +
  labs(x = "District", y = "Beds (%)", fill = "Package") +
  ggtitle("Beds by District and Package") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
```
...
```{r}
package_combined |>
  select(`C1. Which of the following household items do you have?/Cell phone`, package, District) |>
  group_by(package, District) |>
  summarize(
    cell = mean(`C1. Which of the following household items do you have?/Cell phone`)) |>
  mutate(cell = cell * 100)|>
  ggplot(aes(x = District, y = cell, fill = package)) +
  geom_bar(stat = "identity", position = "dodge") +
  labs(x = "District", y = "Cell Phone (%)", fill = "Package") +
  ggtitle("Cell Phones by District and Package") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
```
...
```{r}
package_combined |>
  select(`C1. Which of the following household items do you have?/Chairs`, package, District) |>
  group_by(package, District) |>
  summarize(
    chair = mean(`C1. Which of the following household items do you have?/Chairs`)) |>
  mutate(chair = chair * 100)|>
  ggplot(aes(x = District, y = chair, fill = package)) +
  geom_bar(stat = "identity", position = "dodge") +
  labs(x = "District", y = "Chairs (%)", fill = "Package") +
  ggtitle("Chairs by District and Package") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
```
...
```{r}
package_combined |>
  select(`C1. Which of the following household items do you have?/Hoe`, package, District) |>
  group_by(package, District) |>
  summarize(
    hoe = mean(`C1. Which of the following household items do you have?/Hoe`)) |>
  mutate(hoe = hoe * 100)|>
  ggplot(aes(x = District, y = hoe, fill = package)) +
  geom_bar(stat = "identity", position = "dodge") +
  labs(x = "District", y = "Hoes (%)", fill = "Package") +
  ggtitle("Hoes by District and Package") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
```
...
```{r}
package_combined |>
  select(`C1. Which of the following household items do you have?/Matress`, package, District) |>
  group_by(package, District) |>
  summarize(
    mattress = mean(`C1. Which of the following household items do you have?/Matress`)) |>
  mutate(mattress = mattress * 100)|>
  ggplot(aes(x = District, y = mattress, fill = package)) +
  geom_bar(stat = "identity", position = "dodge") +
  labs(x = "District", y = "Mattress (%)", fill = "Package") +
  ggtitle("Mattresses by District and Package") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
```
...
```{r}
package_combined |>
  select(`C1. Which of the following household items do you have?/Radio`, package, District) |>
  group_by(package, District) |>
  summarize(
    radio = mean(`C1. Which of the following household items do you have?/Radio`)) |>
  mutate(radio = radio * 100)|>
  ggplot(aes(x = District, y = radio, fill = package)) +
  geom_bar(stat = "identity", position = "dodge") +
  labs(x = "District", y = "Radio (%)", fill = "Package") +
  ggtitle("Radio by District and Package") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
```
...
```{r}
package_combined |>
  select(`C1. Which of the following household items do you have?/Solar panel`, package, District) |>
  group_by(package, District) |>
  summarize(
    mattress = mean(`C1. Which of the following household items do you have?/Solar panel`)) |>
  mutate(solar = mattress * 100)|>
  ggplot(aes(x = District, y = solar, fill = package)) +
  geom_bar(stat = "identity", position = "dodge") +
  labs(x = "District", y = "Solar Panel (%)", fill = "Package") +
  ggtitle("Solar Panels by District and Package") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
```
...
```{r}
package_combined |>
  select(`C1. Which of the following household items do you have?/Watering cane`, package, District) |>
  group_by(package, District) |>
  summarize(
    cane = mean(`C1. Which of the following household items do you have?/Watering cane`)) |>
  mutate(cane = cane * 100)|>
  ggplot(aes(x = District, y = cane, fill = package)) +
  geom_bar(stat = "identity", position = "dodge") +
  labs(x = "District", y = "Watering Cane (%)", fill = "Package") +
  ggtitle("Watering Canes by District and Package") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
```
